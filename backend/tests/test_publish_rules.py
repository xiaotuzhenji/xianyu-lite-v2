...
from app.services.publisher import MAX_PUBLISH_IMAGES, _build_item_detail_urls, _copy_item_for_republish, _extract_item_id_from_url, _image_count, _is_offline_pending_text, _merge_item_for_publish, _normalize_publish_result, _parse_image_urls, _summarize_publish_page_text
...
def test_publish_rules():
    ...
    assert _is_offline_pending_text("商品下架中，请稍后") is True
    assert _is_offline_pending_text("商品已下架") is False
